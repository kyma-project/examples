```
  ____      _ _   _____ ____  __        __   _       _   _ ___
 / ___|__ _| | | | ____/ ___| \ \      / /__| |__   | | | |_ _|
| |   / _` | | | |  _|| |      \ \ /\ / / _ \ '_ \  | | | || |
| |__| (_| | | | | |__| |___    \ V  V /  __/ |_) | | |_| || |
 \____\__,_|_|_| |_____\____|    \_/\_/ \___|_.__/   \___/|___|

```

# About

Demo client (JS SPA) to demo Webapp + Kyma + EC OCC API scenario.

## Scenario

- EC customer can login to demo app with EC credentials (implicit flow)
- ID token and token is retrieved (scope openid) and  is validated in Kyma (authentication policy)
- acccess_token is passed as separate header (occ-header)
