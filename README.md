...
|---|---|---|
| [Orders Service](orders-service/README.md) | Test the service that exposes an HTTP API to collect simple orders in in-memory storage or a Redis instance on the cluster. | Go, Redis |
